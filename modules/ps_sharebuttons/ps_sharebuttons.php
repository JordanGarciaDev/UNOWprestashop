...
class Ps_Sharebuttons extends Module implements WidgetInterface
{
    ...
    protected static $networks = ['Facebook', 'Twitter', 'Pinterest', 'Email'];   //se agrega nuevo elemento by jordan
...
//se cambian las posiciones de las redes sociales
        ...
        if (Configuration::get('PS_SC_EMAIL')) {
            $social_share_links['email'] = [
                'label' => $this->trans('Email', [], 'Modules.Sharebuttons.Shop'),
                'class' => 'email',
                'url' => 'https://mailto:ing.jordangarcia@gmail.com=' . $sharing_img . '&url=' . $sharing_url,
                'icono' => '<i class="pccom-icon">;</i>',
            ];
        }
