...
class ProductInformation extends CommonAbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('type_product', FormType\ChoiceType::class, [
            ...
            ->add('campo_personalizable', TranslateType::class, [
                'type' => FormType\TextareaType::class, // https://github.com/symfony/symfony/issues/5906
                'options' => [
                    'attr' => [
                        'class' => 'autoload_rte',
                        'placeholder' => $this->translator->trans('Campo adicional para la prueba de prestashop.<br />', [], 'Admin.Catalog.Help'),
                ...
                'locales' => $this->locales,
                'hideTabs' => true,
                'label' => $this->translator->trans('Campo Peersonalizable Test', [], 'Admin.Catalog.Feature'),
                'required' => false,
            ])
            //FEATURES & ATTRIBUTES
